...
// MFC_EFG_TIME_IO.cpp : 定义应用程序的类行为。
//
...
// 唯一的一个 CMFC_EFG_TIME_IOApp 对象

CMFC_EFG_TIME_IOApp theApp;


// CMFC_EFG_TIME_IOApp 初始化
...
// CMFC_EFG_TIME_IOApp 自定义加载/保存方法
...
void CMFC_EFG_TIME_IOApp::LoadCustomState()
{
}

void CMFC_EFG_TIME_IOApp::SaveCustomState()
{
}
