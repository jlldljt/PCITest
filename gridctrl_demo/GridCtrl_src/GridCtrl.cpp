...
void CGridCtrl::OnVScroll(UINT nSBCode, UINT /*nPos*/, CScrollBar* /*pScrollBar*/)
{
    ...
    SendMessageToParent(m_idCurrentCell.row, m_idCurrentCell.col, GVN_ENDSCROLL);
}
...
void CGridCtrl::ResetScrollBars()
{
    ...
    */
    ...
    ShowScrollBar(SB_VERT, m_bVScrollShow);
    ShowScrollBar(SB_HORZ, m_bHScrollShow);
}

void CGridCtrl::ShowBar(UINT nBar, BOOL bShow) {
  switch (nBar)
  {
  case SB_VERT:
    m_bVScrollShow = bShow;
    break;
  case SB_HORZ:
    m_bHScrollShow = bShow;
    break;
  default:
    return;
  }
